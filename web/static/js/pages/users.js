(() => {
    ...
    function init() {
        ...
        function parseBrowserDate(value) {
        ...
        function isExpired(user) {
            ...
            const date = parseBrowserDate(user.access_expires_at);
        ...
        function openTimelineDrawer() {
            ...
            document.getElementById('timeline-drawer-overlay')?.classList.add('open');
            document.body.style.overflow = 'hidden';
        }

        function closeTimelineDrawer() {
            document.getElementById('timeline-drawer')?.classList.remove('open');
            document.getElementById('timeline-drawer-overlay')?.classList.remove('open');
            document.body.style.overflow = '';
        }
        ...
        document.getElementById('timeline-close-btn')?.addEventListener('click', closeTimelineDrawer);
        document.getElementById('timeline-drawer-overlay')?.addEventListener('click', closeTimelineDrawer);
