...
var emailTextPacks = map[string]emailTextPack{
	...
	"es": {
		...
		UserCreationSubject:      `Cuenta de {{.JellyfinServerName}} creada`,
		UserCreationBody:         "Hola {{.Username}},\n\nUn administrador ha creado tu cuenta de {{.JellyfinServerName}}.\n\nYa puedes iniciar sesion con los datos recibidos.",
	...
	"it": {
		...
		UserCreationSubject:      `Account {{.JellyfinServerName}} creato`,
		UserCreationBody:         "Ciao {{.Username}},\n\nUn amministratore ha creato il tuo account {{.JellyfinServerName}}.\n\nOra puoi accedere con le informazioni ricevute.",
	...
	"nl": {
		...
		UserCreationSubject:      `{{.JellyfinServerName}}-account aangemaakt`,
		UserCreationBody:         "Hallo {{.Username}},\n\nEen beheerder heeft je {{.JellyfinServerName}}-account aangemaakt.\n\nJe kunt nu inloggen met de gegevens die je hebt ontvangen.",
	...
	"pl": {
		...
		UserCreationSubject:      `Konto {{.JellyfinServerName}} utworzone`,
		UserCreationBody:         "Czesc {{.Username}},\n\nAdministrator utworzyl Twoje konto {{.JellyfinServerName}}.\n\nMozesz teraz zalogowac sie uzywajac otrzymanych danych.",
	...
	"pt-br": {
		...
		UserCreationSubject:      `Conta {{.JellyfinServerName}} criada`,
		UserCreationBody:         "Ola {{.Username}},\n\nUm administrador criou sua conta {{.JellyfinServerName}}.\n\nAgora voce pode entrar com os dados recebidos.",
	...
	"ru": {
		...
		UserCreationSubject:      `Аккаунт {{.JellyfinServerName}} создан`,
		UserCreationBody:         "Здравствуйте, {{.Username}}.\n\nАдминистратор создал вашу учетную запись {{.JellyfinServerName}}.\n\nТеперь вы можете войти с полученными данными.",
	...
	"zh": {
		...
		UserCreationSubject:      `已创建 {{.JellyfinServerName}} 账号`,
		UserCreationBody:         "你好 {{.Username}}，\n\n管理员已经为你创建了 {{.JellyfinServerName}} 账号。\n\n你现在可以使用收到的信息登录。",
