...
// @description If viewing docs locally, click the lock icon next to this, login with your normal jellygate credentials. Click 'try it out', then 'execute' and an API Key will be returned, copy it (not including quotes). On any of the other routes, click the lock icon and set the API key as "Bearer `your api key`".
// @Produce json
