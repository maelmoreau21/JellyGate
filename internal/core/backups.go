...
const (
	BACKUP_PREFIX        = "jellygate-db"
	BACKUP_PREFIX_OLD    = "jellygate-db-"
...
// Pre 21/03/25 format: "{BACKUP_PREFIX_OLD}{date in BACKUP_DATEFMT}{BACKUP_SUFFIX}" = "jellygate-db-2006-01-02T15-04-05.bak"
// Post 21/03/25 format: "{BACKUP_PREFIX}-c-{commit}-d-{date in BACKUP_DATEFMT}{BACKUP_SUFFIX}" = "jellygate-db-c-0b92060-d-2006-01-02T15-04-05.bak"
