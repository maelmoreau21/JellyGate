...
func (app *appContext) TestJF(gc *gin.Context) {
	...
	tempjf, _ := mediabrowser.NewServer(serverType, req.Server, "jellygate-setup", app.version, "auth", "auth", mediabrowser.NewNamedTimeoutHandler("authJF", req.Server, true), 30)
