...
type EmailAddress struct {
	...
	Contact             bool
	Admin               bool   // Whether or not user is jellygate admin.
	JellyfinID          string `badgerhold:"key"`
...
// CustomContent stores information needed for creating custom jellygate content, including emails and user messages.
...
// CustomContent stores customized versions of jellygate content, including emails and user messages.
